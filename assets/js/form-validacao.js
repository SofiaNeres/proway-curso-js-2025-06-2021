...
function calcularMedia(){
    ...
    let inputNota2 = document.querySelector("#campo-nota1");
    let inputNota3 = document.querySelector("#campo-nota1");
...
function preencherCampoMedia() {
    ...
    if(isNaN(media) === true){
        //Return sem nd depois n faz o metodo ser com retorno, simplesmente
